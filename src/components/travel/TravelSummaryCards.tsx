...
export default function TravelSummaryCards({ analytics }: TravelSummaryCardsProps) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 [&>*:last-child:nth-child(odd)]:col-span-2 lg:[&>*:last-child:nth-child(odd)]:col-span-1">
      <div className="rounded-2xl border border-slate-200/80 bg-white p-4 sm:p-5 shadow-sm transition-shadow duration-200 hover:shadow-md">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[12px] font-semibold text-slate-500 uppercase tracking-wider truncate">Total Distance</p>
            <p className="text-lg sm:text-3xl font-bold tracking-tight text-slate-900 mt-1.5 sm:mt-2 whitespace-nowrap">
              {analytics.overall.totalKmTraveled.toLocaleString()} <span className="text-[11px] sm:text-sm font-semibold text-slate-400">KM</span>
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-4 sm:p-5 shadow-sm transition-shadow duration-200 hover:shadow-md">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[12px] font-semibold text-slate-500 uppercase tracking-wider truncate">Total Spent</p>
            <p className="text-lg sm:text-3xl font-bold tracking-tight text-slate-900 mt-1.5 sm:mt-2 whitespace-nowrap">
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-4 sm:p-5 shadow-sm transition-shadow duration-200 hover:shadow-md">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[12px] font-semibold text-slate-500 uppercase tracking-wider truncate">Avg Efficiency</p>
            <p className="text-lg sm:text-3xl font-bold tracking-tight text-slate-900 mt-1.5 sm:mt-2 whitespace-nowrap">
              {analytics.overall.averageEfficiency} <span className="text-[11px] sm:text-sm font-semibold text-slate-400">KM/L</span>
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-4 sm:p-5 shadow-sm transition-shadow duration-200 hover:shadow-md">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[12px] font-semibold text-slate-500 uppercase tracking-wider truncate">Avg Price/L</p>
            <p className="text-lg sm:text-3xl font-bold tracking-tight text-slate-900 mt-1.5 sm:mt-2 whitespace-nowrap">
