    ...
    <div className="space-y-4 sm:space-y-6 pb-12 font-sans min-h-screen -mx-4 -mt-4 px-3 py-5 sm:p-8 rounded-tl-3xl transition-colors duration-200">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-2">
        <div>
          ...
          <p className="text-sm font-semibold text-slate-500 dark:text-neutral-400  mt-1">Detailed financial analytics and reports.</p>
        </div>
        ...
        <>
                  ...
                  <div className="mb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-neutral-800  pb-4">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-neutral-400  mt-0.5">Daily activity heatmap</p>
                      </div>
                    </div>
          ...
          {activeTab === 'cashflow' && (
            <div className="grid grid-cols-1 gap-6 animate-fadeIn">
              <div className={cardClasses}>
                <div className="mb-6 flex items-center gap-2"><ArrowRightLeft className="h-5 w-5 text-teal-600" /><div><h3 className={headerClasses}>Cash Flow</h3><p className={subHeaderClasses}>Sankey mapping of Income flowing into Expenses and Savings.</p></div></div>
              ...
              <div className={cardClasses}>
                <div className="mb-6 flex items-center gap-2"><TrendingUp className="h-5 w-5 text-blue-600 dark:text-blue-400" /><div><h3 className={headerClasses}>Cumulative Balance</h3><p className={subHeaderClasses}>Historical timeline of income, expenses, and cumulative balance.</p></div></div>
          ...
          {activeTab === 'behaviors' && (
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 animate-fadeIn xl:[&>*:last-child:nth-child(odd)]:col-span-2">
              ...
              <div className={cardClasses}>
                <div className="mb-6 flex items-center gap-2"><Target className="h-5 w-5 text-purple-600 dark:text-purple-400" /><div><h3 className={headerClasses}>Category Breakdown</h3><p className={subHeaderClasses}>Your spending fingerprint across top categories.</p></div></div>
                    ...
                    <div key={metric.label} className="rounded-xl border border-slate-100 dark:border-neutral-800  bg-slate-50 dark:bg-neutral-800/50 /50 p-3 sm:p-4">
                      ...
                      <div className="mt-2 space-y-1 text-xs text-slate-500 dark:text-neutral-400 ">
                        ...
                        <div className="flex items-center justify-between gap-1 mt-1">
                          ...
                          <span className={`rounded-full px-2 py-0.5 text-[9px] font-black uppercase ${metric.delta.direction === 'up'
                      ...
                      return (
                        <div key={item.label} className="flex items-center justify-between rounded-xl border border-slate-100 dark:border-neutral-800  bg-slate-50 dark:bg-neutral-800/50 /50 px-4 py-3 hover:bg-slate-50  dark:hover:bg-neutral-800/50  transition-colors">
                          ...
                          <div className="text-right">
                            ...
                            <p className={`text-[10px] sm:text-xs font-bold ${delta.direction === 'up' && item.label !== 'Expenses' ? 'text-emerald-600 dark:text-emerald-400' :
          ...
          {activeTab === 'forecasting' && (
            <div className="grid grid-cols-1 gap-6 animate-fadeIn">
              {goalForecastData && !Array.isArray(goalForecastData) ? (
                <div className={cardClasses}>
                  <div className="mb-6 flex items-center gap-2"><TrendingUp className="h-5 w-5 text-emerald-600 dark:text-emerald-400" /><div><h3 className={headerClasses}>Goal Forecast</h3><p className={subHeaderClasses}>Projected completion for top priority: <strong className="text-slate-700 dark:text-neutral-300 ">{goalForecastData.goalName}</strong></p></div></div>
