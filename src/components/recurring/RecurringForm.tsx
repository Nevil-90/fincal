  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-md">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Recurring Transaction</h3>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative w-full">
              <div className="w-full p-2 border border-gray-300 rounded-lg bg-white text-gray-900 flex items-center justify-between pointer-events-none transition-colors">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <p className="text-sm text-yellow-800">
              <span className="flex items-start gap-1.5"><Lightbulb className="h-4 w-4 shrink-0 text-amber-600 mt-0.5" /> <span><strong>Coming Soon:</strong> Price history support will allow you to add price changes over time.</span></span>
